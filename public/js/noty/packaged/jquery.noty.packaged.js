! function(root, factory) {
    ...
    $.noty.layouts.centerBig = {
        ...
        container: {
            object: '<ul id="noty_centerBig_layout_container" />',
            selector: 'ul#noty_centerBig_layout_container',
            style: function() {
                $(this).css({
                    position: 'fixed',
                    width: '510px',
    ...
    $.noty.layouts.centerReallyBig = {
        name: 'centerReallyBig',
        options: { // overrides options

        },
        container: {
            object: '<ul id="noty_centerReallyBig_layout_container" />',
            selector: 'ul#noty_centerReallyBig_layout_container',
            style: function() {
                $(this).css({
                    position: 'fixed',
                    width: '810px',
