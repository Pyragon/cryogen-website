...
public final class InputStream extends Stream {
	...
	public int readSmart2() {
		int i = 0;
		int i_33_ = readUsignedSmart();
		while (i_33_ == 32767) {
			i_33_ = readUsignedSmart();
			i += 32767;
		}
		i += i_33_;
		return i;
	...
	public int read_unsigned_byte128() {
	...
	public int read_unsigned_shortLE() {
