...
public class MaterialProp4 extends MaterialProperty {
    ...
    public int[] method12319(int i_1) {
        ...
        if (aClass320_7667.aBool3722) {
            ...
            if (i_5 > i_9 + anInt9993 && i_5 < i_8 - anInt9993) {
                ...
                JagexArrayUtils.method8365(ints_3, 0, Class316.anInt3670, 0);
            }
        }
    ...
    public void method15422() {
        ...
        for (int i_5 = 0; i_5 < anInt9994; i_5++) {
            ...
            if (i_5 > 0) {
                i_6 = anInt9995;
                i_7 = (method7931(random_2, 4096) - 2048) * anInt9990 >> 12;
                i_6 += i_7 * i_4 >> 12;
            ...
            for (i_6 = 0; i_6 < anInt9982; i_6++) {
                if (i_6 > 0) {
                    i_7 = anInt9988;
                    int i_8 = (method7931(random_2, 4096) - 2048) * anInt9989 >> 12;
                    i_7 += i_8 * i_3 >> 12;
                    anIntArrayArray9979[i_5][i_6] = anIntArrayArray9979[i_5][i_6 - 1] + i_7;
                }

                anIntArrayArray9992[i_5][i_6] = anInt9984 > 0 ? 4096 - method7931(random_2, anInt9984) : 4096;
            }
