...
public class MaterialProp28 extends MaterialProperty {
    ...
    public int[] method12319(int i_1) {
        ...
        if (aClass320_7667.aBool3722) {
            ...
            if (i_17 <= 1) {
                ...
                while (true) {
                    while (true) {
                        int i_22 = i_14 + MaterialProp4.method7931(random_21, i_15 - i_14);
                        int i_23 = i_16 + MaterialProp4.method7931(random_21, i_17 - i_16);
                        int i_24 = i_22 + i_8;
                        ...
                        if (i_24 == Class316.anInt3670) {
                            ...
                            i_13 = 0;
                            i_7 = i_6;
                            i_6 = MaterialProp4.method7931(random_21, Class316.anInt3670);
                            i_5 = i_6 - i_7;
                            i_8 = 0;
                            i_28 = i_5;
                            if (i_5 < 0) {
    ...
    public void method15253(Random random_1, int[][] ints_2, int i_3, int i_4, int i_5, int i_6) {
        int i_8 = anInt9790 > 0 ? 4096 - MaterialProp4.method7931(random_1, anInt9790) : 4096;
        int i_9 = anInt9780 * anInt9789 >> 12;
        int i_10 = anInt9789 - (i_9 > 0 ? MaterialProp4.method7931(random_1, i_9) : 0);
        ...
        if (i_10 > 0) {
                ...
                for (int i_17 = 0; i_17 < i_6; i_17++) {
                    ...
                    if (i_17 < i_14) {
                        ...
                        if (i_16 + i_15 > Class316.anInt3670) {
                            ...
                            JagexArrayUtils.method8365(ints_18, i_15, i_20, i_19);
                            JagexArrayUtils.method8365(ints_18, 0, i_16 - i_20, i_19);
                        } else {
                            JagexArrayUtils.method8365(ints_18, i_15, i_16, i_19);
                        }
                    } else {
                        i_19 = i_6 - i_17 - 1;
                        if (i_19 < i_14) {
                            ...
                            if (i_16 + i_15 > Class316.anInt3670) {
                                ...
                                JagexArrayUtils.method8365(ints_18, i_15, i_21, i_20);
                                JagexArrayUtils.method8365(ints_18, 0, i_16 - i_21, i_20);
                            } else {
                                JagexArrayUtils.method8365(ints_18, i_15, i_16, i_20);
                            }
                        } else {
                            for (i_20 = 0; i_20 < i_13; i_20++) {
                            ...
                            if (i_15 + i_16 > Class316.anInt3670) {
                                i_20 = Class316.anInt3670 - i_15;
                                JagexArrayUtils.method8365(ints_18, i_15, i_20, i_8);
                                JagexArrayUtils.method8365(ints_18, 0, i_16 - i_20, i_8);
                            } else {
                                JagexArrayUtils.method8365(ints_18, i_15, i_16, i_8);
                            }
                        }
                    }
                }
            ...
            for (i_12 = 0; i_12 < i_6; i_12++) {
                ...
                JagexArrayUtils.method8365(ints_23, i_3, i_11, i_8);
                JagexArrayUtils.method8365(ints_23, 0, i_5 - i_11, i_8);
            }
        } else {
            for (i_11 = 0; i_11 < i_6; i_11++) {
                JagexArrayUtils.method8365(ints_2[i_11 + i_4], i_3, i_5, i_8);
            }
        }
    }
}
