...
public class Register {
    ...
    public static String completeRegistration(Request request, Response response) {
        ...
        if(result != null)
            return result;
        if(!DisplayNames.nameAllowed(username))
        ...
        Account account = new Account(-1, username, hash, salt, 0, 0, null, "", null, null, -1, "", request.ip(), false, false, false, 0, null, null, null, -1, -1, null, null);
