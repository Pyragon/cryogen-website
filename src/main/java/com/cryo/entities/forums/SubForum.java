...
public class SubForum extends MySQLDao {
    ...
    public ArrayList<SubForum> getSubForums() {
        return getConnection("cryogen_forum").selectList("subforums", "parent_id=?", "ORDER BY priority ASC", SubForum.class, id);
    }
    ...
    public SubForum getParent() {
        return getConnection("cryogen_forum").selectClass("subforums", "id=?", SubForum.class, parentId);
    }
    ...
    public ArrayList<Thread> getThreads() {
        ...
        ArrayList<Thread> list = getConnection("cryogen_forum").selectList("threads", "forum_id=? && archived=0", Thread.class, id);
    ...
    public Permissions getPermissions() {
        if (permissionsId == -1) {
            ...
            if (parent == null)
                return getConnection("cryogen_forum").selectClass("permissions", "id=?", Permissions.class, 2);
            return parent.getPermissions();
        }
        return getConnection("cryogen_forum").selectClass("permissions", "id=?", Permissions.class, permissionsId);
    }
